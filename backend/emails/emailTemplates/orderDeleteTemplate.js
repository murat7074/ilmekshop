               ...
               <td valign="top" class="pc-w620-padding-20-24-0-24" style="padding: 0px 32px 0px 32px; border-radius: 0px; background-color: #FFFFFF;" bgcolor="#FFFFFF">
                                ...
                                <tr>
                                 <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 0px 0px 0px;">
                                  <div class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-100pc" style="line-height: 150%; letter-spacing: -1px; font-family: 'Nunito Sans', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: normal; font-variant-ligatures: normal; color: #121212; text-align: center; text-align-last: center;">
                                   <div><span style="font-weight: 700;font-style: normal;color: rgb(22, 23, 24);letter-spacing: 1px;" data-letter-spacing-original="1">Üzgünüz... Siparişiniz İptal Edilmiştir.</span>
                                   </div>
                ...
                <![endif]-->
                          ...
                          <tr>
                           ...
                           <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
  <tr>
    <td align="center" valign="middle" style="padding: 0 0 24px 0;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; width: 100%;">
        <tr>
          <td align="center" valign="middle">
            <img src="https://res.cloudinary.com/dwzrxtidw/image/upload/v1718453584/beybuilmek/email/n1wqny5lbjhsf4x4baos.png" 
                 width="40" 
                 height="40" 
                 alt="" 
                 style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 40px; height: 40px; max-width: 100%; border-radius: 50%;" />
          </td>
        </tr>
      </table>
    </td>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td valign="top">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
              <tr>
                <td valign="middle" style="width: 50%; padding: 0;">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                    <tr>
                      <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="center">
                                      <tr>
                                        <td valign="top" align="center">
                                          <div class="pc-font-alt pc-w620-fontSize-14px" style="line-height: 150%; letter-spacing: -0px; font-family: 'Nunito Sans', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; color: #121212cc; text-align: center;">
                                            <div style="margin-bottom: 10px;"><span style="font-weight: 400; font-style: normal;">Başlık : ${title}</span></div>
                                            <div style="margin-bottom: 20px;"><span style="font-weight: 400; font-style: normal;">Konu : ${message}</span></div>
                                            <div><span style="font-weight: 400; font-style: italic; color: rgb(75, 85, 99);">Eğer bu sayfayı düzgün görüntüleyemiyorsanız Mesajlarım hesabından bakabilirsiniz.</span></div>
                                          </div>
                                        </td>
                                      </tr>
                                    </table>
