...
export const orderReturnRequestTemplateForSeller = (
  userShippingInfo,
  orderInfo,
  orderProducts,
  message,title
                                ...
                                <tr>
                                 <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 0px 0px 0px;">
                                  <div class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-100pc" style="line-height: 150%; letter-spacing: -1px; font-family: 'Nunito Sans', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: normal; font-variant-ligatures: normal; color: #121212; text-align: center; text-align-last: center;">
                                   <div><span style="font-weight: 700;font-style: normal;color: rgb(22, 23, 24);letter-spacing: 1px;" data-letter-spacing-original="1">Müşteri Tarafından Ürün İade Talebi Oluşturuldu.</span>
                                   </div>
                                   <div><span>﻿</span>
                                   </div>
                                   <div><span style="font-weight: 500;font-style: normal;letter-spacing: 0px;" data-letter-spacing-original="0">Talebi incelendikten sonra müşteriye cevabı bildiriniz.</span>
                                   </div>
                                  </div>
                                 </td>
                                </tr>
