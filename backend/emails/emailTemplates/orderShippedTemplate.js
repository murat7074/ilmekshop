                                ...
                                <tr>
                                 <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 0px 0px 0px;">
                                  <div class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-100pc" style="line-height: 150%; letter-spacing: -1px; font-family: 'Nunito Sans', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: normal; font-variant-ligatures: normal; color: #121212; text-align: center; text-align-last: center;">
                                   <div><span style="font-weight: 700;font-style: normal;color: rgb(22, 23, 24);letter-spacing: 1px;" data-letter-spacing-original="1">Siparişiniz Kargoya Verildi.</span>
                                   </div>
                                   <div><span>﻿</span>
                                   </div>
                                   <div><span style="font-weight: 500;font-style: normal;letter-spacing: 0px;" data-letter-spacing-original="0">Alışveriş için Beybuilmek&#39;i tercih ettiğiniz için teşekkür ederiz. Faturanızı siparişlerim hesabından indirebilirsiniz.</span>
                                   </div>
                                  </div>
                                 </td>
                                </tr>
                                               ...
                                               <tr>
                                                <td valign="top" align="center">
                                                 <div class="pc-font-alt pc-w620-fontSize-14px" style="line-height: 150%; letter-spacing: -0px; font-family: 'Nunito Sans', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; font-variant-ligatures: normal; color: #121212cc; text-align: center; text-align-last: center;">
                                                  <div><span style="font-weight: 400;font-style: normal;">Kargo teslimat süresi tahmini 3 iş günüdür. </span>
                                                  </div>
                                                  <div><span style="font-weight: 400;font-style: italic;color: rgb(75, 85, 99);">Eğer bu sayfayı düzgün görüntüleyemiyorsanız lütfen Siparişlerim hesabından bakabilirsiniz.</span>
                                                  </div>
                                                  <div><span style="color: rgb(18, 18, 18);">Kargo Firması : </span><span style="color: rgba(6, 1, 21, 0.6);"> </span><span style="color: rgb(255, 85, 74);">${shippedFirmForEmail}</span>
                      </div>
                                                   <div><span style="color: rgb(18, 18, 18);">Kargo Takip Numarası : </span><span style="color: rgba(6, 1, 21, 0.6);"> </span><span style="color: rgb(255, 85, 74);">${shippedNoForEmail}</span>
                       </div>
                                                 </div>
                                                </td>
                                               </tr>
